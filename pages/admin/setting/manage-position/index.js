...
import ManagePositionScreen from '@/features/admin/setting/manage-position/screen/index'
...
const ManagePositionPage = (props) => {
  const { } = props

  return (
    <AppProvider>
      <Layout>
        <ManagePositionScreen />
      </Layout>
    </AppProvider>
  )
}
...
export default React.memo(ManagePositionPage)
