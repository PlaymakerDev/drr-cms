    ...
    <Card className="!p-0">
      <div className="flex space-x-4 !w-full !h-full">
        ...
        <article className="flex-1 flex flex-col items-center hover:bg-gray-100">
          <Image src={Hotline} alt="hotline" width={50} height={50} />
          <Typography.Text className="text-lg font-bold mb-5 mt-2">
            สายด่วน 1146
          </Typography.Text>
          <div className="flex-1" />
          <section className="flex items-end space-x-1 pt-6">
            <Typography.Text className="text-4xl font-bold">
              286
            </Typography.Text>
        ...
        <article className="flex-1 flex flex-col items-center hover:bg-gray-100">
          <Image src={Traffic} alt="hotline" width={50} height={50} />
          <Typography.Text className="text-lg font-bold mb-5 mt-2">
            Traffic Fondue
          </Typography.Text>
          <div className="flex-1" />
        ...
        <article className="flex-1 flex flex-col items-center hover:bg-gray-100">
          <Image src={Facebook} alt="hotline" width={50} height={50} />
          <Typography.Text className="text-lg font-bold mb-5 mt-2">
            Facebook
          </Typography.Text>
          <div className="flex-1" />
        ...
        <article className="flex-1 flex flex-col items-center hover:bg-gray-100">
          <Image src={GECC} alt="hotline" width={50} height={50} />
          <Typography.Text className="text-lg font-bold mb-5 mt-2">
            ศูนย์ราชการสะดวก
          </Typography.Text>
          <div className="flex-1" />
        ...
        <article className="flex-1 flex flex-col items-center hover:bg-gray-100">
          <Image src={WWW} alt="hotline" width={50} height={50} />
          <Typography.Text className="text-lg font-bold mb-5 mt-2">
        ...
        <article className="flex-1 flex flex-col items-center hover:bg-gray-100">
          <Image src={WWW2} alt="hotline" width={50} height={50} />
          <Typography.Text className="text-lg font-bold mb-5 mt-2">
        ...
        <article className="flex-1 flex flex-col items-center hover:bg-gray-100">
          <Image src={WWW3} alt="hotline" width={50} height={50} />
          <Typography.Text className="text-lg font-bold mb-5 mt-2">
        ...
        <article className="flex-1 flex flex-col items-center hover:bg-gray-100">
          <Image src={Book} alt="hotline" width={50} height={50} />
          <Typography.Text className="text-lg font-bold mb-5 mt-2">
            หนังสือภายนอก
          </Typography.Text>
          <div className="flex-1" />
